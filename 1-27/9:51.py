...
# Function to clear the screen by printing newlines
def clear_screen():
    print("\n" * 100)
...
def interactive_recipe_search():
    ...
    # Mexican Cuisine
    recipe_book.add_recipe(Recipe("Beef Tacos", ["tortilla", "beef", "lettuce", "cheese", "salsa"], "Mexican", ["taco"]))
    recipe_book.add_recipe(Recipe("Breakfast Tacos", ["tortilla", "bacon", "eggs", "cheese", "salsa"], "Mexican", ["breakfast taco"], breakfast_taco_instruction))
    recipe_book.add_recipe(Recipe("Pork Tacos", ["tortilla", "pork", "lettuce", "cheese", "salsa"], "Mexican", ["pork taco"]))
    recipe_book.add_recipe(Recipe("Guacamole", ["avocado", "onion", "tomato", "lime"], "Mexican", ["guac"]))
    recipe_book.add_recipe(Recipe("Enchiladas", ["tortilla", "chicken", "cheese", "enchilada sauce"], "Mexican", ["enchiladas"]))
    recipe_book.add_recipe(Recipe("Burritos", ["tortilla", "rice", "beans", "meat", "cheese"], "Mexican", ["burritos"]))

    # American Cuisine
    recipe_book.add_recipe(Recipe("Pancakes", ["flour", "milk", "eggs", "butter", "syrup"], "American", ["pancakes"]))
    recipe_book.add_recipe(Recipe("Burger", ["burger buns", "ground beef", "lettuce", "tomato", "cheese"], "American", ["burger"], burger_instruction))
    recipe_book.add_recipe(Recipe("Apple Pie", ["apples", "granulated sugar", "brown sugar", "lemon juice", "cinnamon", "nutmeg", "ginger", "butter", "flour", "cornstarch", "heavy cream", "coarse sugar", "pie crusts"], "American", ["apple pie"], apple_pie_instruction))
